...
data_names =['derby_perf']
clf_names = ['mlp','rf'] #,'nb','lr','svm','mlp','rf'

for data_name in data_names:
    print("begin: ", data_name)
    input_file0 = "../input_perf/" + data_name + "_0.csv"
    input_file1 = "../input_perf/" + data_name + "_1.csv"
    ...
    for clf_name in clf_names:
        ...
        kfold_output = '../output_perf/bl_farsec/farsec_' + data_name + \
                               '_' + clf_name +'_output.csv'        
